...
SnowflakeOS OS-Installer Configuration
===
...
SnowflakeOS is a NixOS based Linux distribution focused on beginner friendliness and ease of use. This repository contains the SnowflakeOS configurations for [OS-Installer](https://gitlab.gnome.org/p3732/os-installer).
